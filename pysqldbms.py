...
class Customer:
    ...
    def print_all(self):
        a = ("Customer #"+ str(self.customer_id))
...
def customer_menu(database, cursor):
    while True:
        ...
        1. New Customer
        2. Show Customer Details by name
        3. Show customer details by customer_id
        4. Show customer details by address
        5. Show customer details by phone number
        6. Show customer details by room no
        7. Show customer details by check in date
        8. Show current list of customers
        9. Check out
        ...
        if choice == 1:
            ...
            customer_id = pyautogui.prompt("Enter the customer id: ")
